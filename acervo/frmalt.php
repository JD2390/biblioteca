...
<head>
  ...
  <title>Alteração de Acervo</title>
        ...
        <div class="row"> 
          <div class="col-lg-12">
            <div class="card card-primary card-outline">
              <div class="card-body">
                <form name="f1" action="../controle/acervo/atualizar.php?id='.$linha['id_usuario'].'" method="POST" onsubmit="return validar()">
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <div class="input-group">
                        ...
                        <input value="<?php echo $busca->getTitulo();?>" name="titulo" type="text" class="form-control" placeholder="Informe o Titulo" required>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <div class="input-group">
                        ...
                        <input value="<?php echo $busca->getNpaginas();?>" name="npaginas" type="text" class="form-control" placeholder="Informe o Nº de Paginas" required>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
