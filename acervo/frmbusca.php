  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Busca do Acervo</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
                      ...
                      <tbody>
                        <?php
                          if (isset($_POST['texto'])) {
                            ...
                            //criando objeto para a classe AcervoCRUD
                            ...
                            foreach ($busca as $linha) {
                              echo '<tr>
                                      ...
                                      <td>'.$linha['autor'].'</td>
                                      <td width="20%">
                                      <a href="frmalt.php?id='.$linha['id_acervo'].'" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i>&nbsp;Alterar</a>
                                      <a href="../controle/acervo/apagar.php?id='.$linha['id_acervo'].'" onclick="validarDelete()" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i>&nbsp;Excluir</a>
                                      </td>
                                    </tr>';
                            }
                          }
