	...
	class AcervoCRUD implements InterfaceCRUD{
		...
		public function salvar($objeto){
			...
			try{
				...
				$operacao->bindValue(":ano_publicacao",$ano_publicacao,PDO::PARAM_INT);
				$operacao->bindValue(":editora",$editora,PDO::PARAM_STR);
				$operacao->bindValue(":npaginas",$npaginas,PDO::PARAM_INT);
				$operacao->bindValue(":exemplar",$exemplar,PDO::PARAM_INT);
