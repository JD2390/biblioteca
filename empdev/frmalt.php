					...
					<div class="form-group">
	                    <div class="col-md-12">
	                      ...
	                      <div class="input-group">
	                        ...
	                        <input value="<?php echo $_GET['titulo']?>" type="text" class="form-control" readonly="true">
	                      </div>
	                    </div>
                  	</div>
                  	<div class="form-group">
	                    <div class="col-md-12">
	                      ...
	                      <div class="input-group">
	                        ...
	                        <input value="<?php echo $_GET['leitor']?>" type="text" class="form-control" readonly="true">
	                      </div>
	                    </div>
                  	</div>
