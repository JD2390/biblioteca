        ...
        <div class="row"> 
          <div class="col-lg-12">
            <div class="card card-primary card-outline">
              <div class="card-body">
                <form name="f1" action="../controle/leitor/atualizar.php?id='.$linha['id_leitor'].'" method="POST" onsubmit="return validar()">
                  ...
                  <div class="form-group">
                    <div class="col-md-6">
                      ...
                      <div class="input-group">
                        ...
                        <input value="<?php echo $busca->getCpf();?>" name="cpf" type="text" class="form-control" placeholder="Informe seu CPF" required>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-md-4">
                      ...
                      <div class="input-group">
                        ...
                        <select name="sexo" class="form-control">
                          <option value="M"<?php echo selected( 'M', $busca->getSexo() ); ?>>Masculino</option>
                          <option value="F"<?php echo selected( 'F', $busca->getSexo() ); ?>>Feminino</option>
                        </select>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-md-6">
                      ...
                      <div class="input-group">
                        ...
                        <input value="<?php echo $busca->getFone();?>" name="fone" type="text" class="form-control" placeholder="Informe o Nº de Telefone" required>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-md-6">
                      ...
                      <div class="input-group">
                        ...
                        <input value="<?php echo $busca->getRua();?>" name="rua" type="text" class="form-control" placeholder="Informe o Logadouro" required>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-md-6">
                      ...
                      <div class="input-group">
                        ...
                        <input value="<?php echo $busca->getNumero();?>" name="numero" type="text" class="form-control" placeholder="Informe o Nº da Casa" required>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
