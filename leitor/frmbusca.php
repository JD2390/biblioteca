...
<head>
  ...
  <title>Busca de Livros no Acervo</title>
                      ...
                      <tbody>
                        <?php
                          if (isset($_POST['texto'])) {
                            ...
                            //criando objeto para a classe LeitorCRUD
                            ...
                            foreach ($busca as $linha) {
                              echo '<tr>
                                      ...
                                      <td>'.$linha['email'].'</td>
                                      <td width="20%">
                                      <a href="frmalt.php?id='.$linha['id_leitor'].'" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i>&nbsp;Alterar</a>
                                      <a href="../controle/acervo/apagar.php?id='.$linha['id_leitor'].'" onclick="validarDelete()" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i>&nbsp;Excluir</a>
                                      </td>
                                    </tr>';
                            }
                          }
